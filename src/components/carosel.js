...
import Img2 from '../asset/images/image2.png'
const Carosel = () => {
    ...
    return (
        ...
        <div class="caroselcust">
            <Carosels>
            <figure class="snip0057 red hover row">
  <figcaption >
    <h2>My <span>Profile</span></h2>
    <p>I'm a person who doesn't like taking pictures."</p>
    <div class="icons"><a href="#"><i class="ion-ios-home"></i></a><a href="#"><i class="ion-ios-email"></i></a><a href="#"><i class="ion-ios-telephone"></i></a></div>
  </figcaption>
  <div class="image"><img src={Img1} alt="sample4"/></div>
  <div class="position">Profile</div>
</figure>
<figure class="snip0057 blue">
  <figcaption>
    <h2>My <span>Future</span></h2>
    <p>I love and I like computers when I graduated high school so I chose to go to the Faculty of Information Technology.</p>
    <div class="icons"><a href="#"><i class="ion-ios-home"></i></a><a href="#"><i class="ion-ios-email"></i></a><a href="#"><i class="ion-ios-telephone"></i></a></div>
  </figcaption>
  <div class="image"><img src={Img2} alt="sample3"/></div>
